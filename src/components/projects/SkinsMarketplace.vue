            ...
            <div class="mt-2">
                <p>
                    Frameworks utilizados: <span class="font-bold">PHP 8.1</span>, <span class="font-bold">Laravel
                        ...
                        3</span>, <span class="font-bold">TailwindCSS</span>, <span class="font-bold">Ionic 7.0</span> e
                    <span class="font-bold">MySQL</span>
                </p>
            </div>

            <div class="mt-4">
                <a href="https://github.com/MatheusCavalc/SkinsMarketplace" target="_blank">
                    <button type="button"
