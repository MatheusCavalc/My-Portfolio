...
import image1 from '../../assets/images/Invoice-App-1.png';
import image2 from '../../assets/images/Invoice-App-2.png';
import image3 from '../../assets/images/Invoice-App-3.png';
import image4 from '../../assets/images/Invoice-App-4.png';
import image5 from '../../assets/images/Invoice-App-5.png';

import image6 from '/src/assets/images/Invoice-App-Movel-1.png'
import image7 from '/src/assets/images/Invoice-App-Movel-2.png'
import image8 from '/src/assets/images/Invoice-App-Movel-3.png'
...
<template>
        ...
        <div class="mt-5 lg:mt-20 lg:w-2/5" data-animation="right">
            <div class="w-full md:w-96">
                <div class="mt-4 md:mt-0">
                    <h1 class="text-2xl font-bold text-center md:text-4xl">Nota Fiscal App</h1>
                </div>

                <div class="mt-6 md:ml-3">
                    <p class="">
                        Nota Fiscal App é um app para gerenciar faturas ou notas fiscais. Registre e faça o download de
                        notas
                        fiscais de forma automatizada
                    </p>
                </div>
            </div>
            ...
            <div class="mt-2 md:ml-3">
                <p>
                    Frameworks utilizados: <span class="font-bold">PHP 8.1</span>, <span class="font-bold">Laravel
                        10</span>, <span class="font-bold">FilamentPHP 3.0</span> e <span class="font-bold">MySQL</span>
                </p>
            </div>

            <div class="mt-2 md:ml-3">
                <p class="flex">
                    Repositório: <a href="https://github.com/MatheusCavalc/Invoice-App" target="_blank"
                        class="ml-1 font-bold text-slate-800 hover:underline">Github</a> <span><img
                            class="w-5 h-5 md:h-6 md:w-6" src="../../assets/icons/redirect.svg" alt=""></span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="flex justify-center my-10">
        <div class="w-full h-1 rounded-full md:w-4/5 bg-slate-800"></div>
    </div>
</template>